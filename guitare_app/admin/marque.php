...
if(isset($_GET['flag'])){
    ...
    if($_GET['flag']==1){
        ...
        echo"<div class='alert alert-success alert-dismissible fade show' role='alert'>
            <strong>Marque enregistrée !</strong> 
...
if(isset($_GET['idSuppression']))
{
    ...
    if(existInBase($id,'Marque')){
        $marqueToDrop=MarqueRepo::getMarque($id);
    }
    

    if($marqueToDrop !== null){
        if(!MarqueRepo::dropModele($marqueToDrop)){
            ...
            echo"<div class='alert alert-success alert-dismissible fade show' role='alert'>
                <strong>Marque supprimée !</strong> 
                <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                </div>";
        ...
        header("location:../erreur/error_login.php");
        exit();
    }
...
$listeMarques=MarqueRepo::getMarques();
usort($listeMarques,"order");
?>
...
<html>
    ...
    <div class='container' >
        <div class="card" style='margin-top:10vh;'>
            ...
            <div class="card-body">
                <span>            
                    <a href="marque.php" class="btn btn-outline-danger">Marque</a>
                ...
                <a href='formulaireMarque.php' class='btn btn-primary'>Ajouter</a>
                <hr>
                <!--la liste des genres-->
                <table class="table ">
                    <thead>
                        <tr>
                            <th scope="col" style='width:80%;'>Marque</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row"><?= getNomObject($marque)?></th>
                            <td><a href='formulaireMarque.php?idMarque=<?=$marque->getIdMarque()?>' class='btn btn-primary'>Modifier</a></td>
                            <td><a href='warning.php?idSuppression=<?=getIdObject($marque)?>&classe=<?=get_class($marque)?>' class='btn btn-danger'>Supprimer</a></td>
